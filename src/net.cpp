...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Mahacoin " + FormatFullVersion();
...
<<<<<<< HEAD
    {"mahcoin.com", "dnsseed.mahcoin.com"},
=======
    {"mahcoin.com","dnsseed.mahcoin.com"},
>>>>>>> d62ddf3359a7c6fd59bd6579e2b846b723b22a14
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"mahcoin.com", "testnet-seed.mahcoin.com"},
    {"mahcoin.com","testnet-seed.mahcoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Mahacoin is probably already running."), addrBind.ToString().c_str());
        else
